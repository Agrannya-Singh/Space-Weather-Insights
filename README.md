...
*   Real-time Data: Access the latest solar events from the NASA DONKI database.
*   Interactive Visualizations: Explore solar flares, coronal mass ejections (CMEs), and other events through charts and maps.
*   Detailed Event Information: Review comprehensive descriptions and relevant data points for each event.
*   AI-Powered Summaries: Obtain concise summaries of events generated by AI.
...
*   User-Friendly Interface: Navigate the dashboard with a clean and intuitive design.
*   In built rate limiting via google OCID preventing genAI abuse


*   Next.js: A React framework for building fast and scalable web applications.
*   Firebase: A platform providing backend services like hosting, authentication, and databases.
### Getting Started

*   Next.js: A React framework for building fast and scalable web applications.
*   Firebase: A platform providing backend services like hosting, authentication, and databases.
*   Genkit: Integrated for AI capabilities, specifically for generating event summaries.
*   NASA DONKI API: The source of solar activity data.
*   Shadcn UI: A UI component library.
*   Tremor: Used for building interactive charts.
...
This project utilizes data from the NASA Space Weather Database of Notifications, Knowledge, and Information (DONKI) API. This API provides information about solar and geophysical events that can affect Earth.
...
We extend our gratitude to NASA for providing the data through the DONKI database.
